namespace CloudFlare.Client.Api.Parameters.Endpoints
{
    public static class SettingsEndpoints
    {
        ...
        public const string OpportunisticOnion = "opportunistic_onion";
        ...
        public const string HotlinkProtection = "hotlink_protection";
        public const string IpGeolocation = "ip_geolocation";
